    ...
    <div className="w-full radial4">
      ...
      >
        <SwiperSlide className="swiper-slide">
          <div className="bg-sliderItem border-[12px] border-white rounded-[72px] p-4 lg:p-5 flex items-center justify-center">
        ...
        <div className="flex justify-center slider-controler mt-[1.31rem] gap-[6.44rem]">
